// __expected:copy_1(len => dest, src => dest)
void copy_1(int len, int* src, int* dest) {
  for (int i = 0; i < len; i++)
    dest[i] = src[i];
}

// __expected:copy_2(len => dest, src => dest)
